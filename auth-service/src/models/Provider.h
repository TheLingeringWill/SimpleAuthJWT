...
public:
   ...
   */
  explicit Provider(const Json::Value& pJson) noexcept(false);
  ...
  void
  setName(const std::string& pName) noexcept;
  void
  setName(std::string&& pName) noexcept;
  void
  setNameToNull() noexcept;

  /**  For column wsep  */
  /// Get the value of the column wsep, returns the default value if the column
  /// is null
  const std::string&
  getValueOfWsep() const noexcept;
  /// Return a shared_ptr object pointing to the column const value, or an empty
  /// shared_ptr object if the column is null
  const std::shared_ptr<std::string>&
  getWsep() const noexcept;
  /// Set the value of the column wsep
  void
  setWsep(const std::string& pWsep) noexcept;
  void
  setWsep(std::string&& pWsep) noexcept;
  void
  setWsepToNull() noexcept;
...
private:
  friend drogon::orm::Mapper<Provider>;
#ifdef __cpp_impl_coroutine
  friend drogon::orm::CoroMapper<Provider>;
#endif
  ...
  std::shared_ptr<std::string> wsep_;
